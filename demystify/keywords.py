...
_subtypes = (_artifact_types + _creature_types + _enchantment_types
             + _land_types + _plane_types + _spell_types)
subtypes = {}
for st in _subtypes:
    for word, token in st.dict.items():
        subtypes[word] = token
for pt in _planeswalker_types:
    subtypes[pt] = pt.upper()
...
_concepts = [
    ...
    Keyword(("DIFFERENTLY", "differently")),
